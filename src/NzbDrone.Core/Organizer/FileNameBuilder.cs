...
namespace NzbDrone.Core.Organizer
{
    ...
    public class FileNameBuilder : IBuildFileNames
    {
        ...
        public static readonly Regex EpisodeRegex = new Regex(@"(?<episode>\{(?:episode|chapter)(?:\:0+)?})",
                                                               RegexOptions.Compiled | RegexOptions.IgnoreCase);

        public static readonly Regex SeasonRegex = new Regex(@"(?<season>\{(?:season|volume)(?:\:0+)?})",
                                                              RegexOptions.Compiled | RegexOptions.IgnoreCase);
